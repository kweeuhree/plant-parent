...
var connectToDb_1 = require("./(lib)/connectToDb");
var User_1 = require("./(models)/User");
var Index = function (_a) {
    var users = _a.users;
    return (<>
        {users.map(function (user, index) { return (<div key={index}>
            <div className="card">
...
var getServerSideProps = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                result = _a.sent();
                users = result.map(function (doc) {
                    var user = JSON.parse(JSON.stringify(doc));
                    return user;
                });
                return [2 /*return*/, { props: { users: users } }];
        }
    });
}); };
